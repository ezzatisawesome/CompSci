...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void load() {
        try {
            ...
            String teamName = loadFile.readLine();
            String teamMascot = loadFile.readLine();
    ...
    private void addGame() {
        for (int p = 0; p < team.getPlayers().size(); p++) {
            team.getPlayers().get(p).addGoals(0);
        }
        team.setNumGames(team.getNumGames()+1);
        gameDeleter.addItem("Game " + team.getNumGames());
        refreshPanels();
    }
    ...
    private void drawGoalPanel() {
        ...
        for (int x = 0; x < goalsData.length; x++) {
            ...
            for (int n = 2; n <= team.getNumGames() + 1; n++) {
                ...
                numGoals += team.getPlayers().get(x).getGoals(n-2); //ez
                
                check = n; //ez
            }
            if(numGoals >= prevGoals) { //ez
                    bestGame = check; //ez
                }
                prevGoals = numGoals; //ez
                numGoals = 0; //ez
        }
    ...
    private void initComponents() {
        ...
        gameDeleter = new javax.swing.JComboBox<>();
        ...
        teamInfoPanelLayout.setVerticalGroup(
            ...
            .addGroup(teamInfoPanelLayout.createSequentialGroup()
                ...
                .addGroup(teamInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(switchPanelButton)
                    .addComponent(jButton1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        infoPanelLayout.setVerticalGroup(
            ...
            .addGroup(infoPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(infoScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 227, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        gameDeleter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Game 1", "Game 2", "Game 3" }));
        gameDeleter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gameDeleterActionPerformed(evt);
            }
        });

        deleteGame.setText("Delete");
        ...
        goalsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, goalsPanelLayout.createSequentialGroup()
                ...
                .addGroup(goalsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(gameDeleter, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        goalsPanelLayout.setVerticalGroup(
            goalsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, goalsPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(goalsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(goalsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(addGameButton)
                    .addComponent(gameDeleter, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField2.setText("Game " + bestGame);
        
        
        
    }//GEN-LAST:event_jButton1ActionPerformed

    private void gameDeleterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gameDeleterActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_gameDeleterActionPerformed
    ...
    private void deleteGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteGameActionPerformed
        ...
        String game = gameDeleter.getSelectedItem().toString();
        int numGames = team.getNumGames();
        team.setNumGames(numGames - 1);
        gameDeleter.removeItem("Game " + numGames);
        refreshPanels();
    ...
    private javax.swing.JComboBox<String> gameDeleter;
