...
public class AddPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        positionChooser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Defender", "Midfield", "Goalie", "Forward" }));
        positionChooser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                positionChooserActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(49, 49, 49)
                        .addComponent(positionChooser, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(positionLabel)
                    .addComponent(positionChooser, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            ...
            String position = positionChooser.getSelectedItem().toString();
            number = Integer.parseInt(numberTextField.getText());
            
            if (firstNameTextField.getText().equals("") || lastNameTextField.getText().equals("")) {
                throw new IllegalArgumentException("Blank Names");
            }
            ...
            try {
                if(number < 0) {
                  ...
                  JOptionPane.showMessageDialog(null, "Negative Player Number");
            }
    ...
    private void positionChooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_positionChooserActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_positionChooserActionPerformed
